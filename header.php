    ...
    <body>
        ...
        <header class="header__section">
            ...
            <div class="main__header position__relative header__sticky">
                <div class="container">
                    <div
                        class="main__header--inner d-flex justify-content-between align-items-center">
                            ...
                            <a class="offcanvas__header--menu__open--btn"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    viewBox="0 0 512 512"><path
                                        ...
                                        d="M80 160h352M80 256h352M80 352h352" /></svg>
                    ...
                    <li class="offcanvas__stikcy--toolbar__list ">
                        <a class="offcanvas__stikcy--toolbar__btn "
                            ...
                            <span class="offcanvas__stikcy--toolbar__label "
                                data-open="modal1">Contact</span>
                            <!-- <span class="items__count wishlist__count">3</span>  -->
                        </a>
                    </li>

                    <!-- Quickview Wrapper Model -->
                    <div class="modal" id="modal1" data-animation="slideInUp">
                        <div class="modal-dialog quickview__main--wrapper">
                            <header class="modal-header quickview__header">
                                <button
                                    class="close-modal quickview__close--btn"
            ...
            <div class="offCanvas__minicart" tabindex="-1">
                ...
                <div class="minicart__product">
                    <div class="minicart__product--items d-flex">
                        ...
                        <div class="minicart__text">
                            <h4 class="minicart__subtitle"><a
                                    href="product-details.html">TAdvanced
                                    Analytic</a></h4>
                    ...
                    <div class="minicart__product--items d-flex">
                        ...
                        <div class="minicart__text">
                            <h4 class="minicart__subtitle"><a
                                    href="product-details.html">Warrison
                                    Samuel.</a></h4>
                            <span class="color__variant"><b>Color:</b>
                                Green</span>
                            <div class="minicart__price">
                ...
                <div class="minicart__conditions text-center">
                    ...
                    <label class="minicart__conditions--label" for="accept">I
                        agree with the <a class="minicart__conditions--link"
                            href="privacy-policy.html">Privacy And
                            Policy</a></label>
                </div>
            ...
            <div class="predictive__search--box " tabindex="-1">
                ...
                <button class="predictive__search--close__btn"
                    aria-label="search close btn" data-offcanvas>
